...
//Dialogue triggered by interacting with the shop
        ...
        switch(GameManager.Instance.day){
            case 1:
                if(DecisionManager.Instance.puzzleDoneDay1){
                    DialogueManager.Instance.StartConversation("ShopDoorsNightDialogue");
                    //Plays a sound effect if it's locked
                    AudioManager.Instance.PlaySoundEffect(AudioManager.Instance.locked);
                }
                else{
                    DialogueManager.Instance.StartConversation("ShopDay1");
                    AudioManager.Instance.PlaySoundEffect(AudioManager.Instance.locked);
                }
                break;
            case 2:
                if(DecisionManager.Instance.puzzleDoneDay2){
                    ...
                    DialogueManager.Instance.StartConversation("ShopDay2");
                    AudioManager.Instance.PlaySoundEffect(AudioManager.Instance.locked);
                }
                break;
            case 3:
