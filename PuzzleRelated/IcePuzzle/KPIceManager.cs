...
//Controls the dialogue of day 3's puzzle with Simon
public class KPIceManager : MonoBehaviour
{
    void Start()
    {
        ...
        if(!DialogueManager.Instance.puzzleDialogueDone){
            DialogueManager.Instance.StartConversation("Day2PuzzleStartSimon");
